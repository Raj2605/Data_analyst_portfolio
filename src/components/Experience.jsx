...
const EXPERIENCE = [
  {
  role: 'Analyst | Bloomberg Project',
  org: 'Wipro',
  period: 'Jun 2026 – Present',
  location: 'Gurgaon, India',
  description:
    'Performed data quality analysis and QA validation across Bloomberg Economy & Energy datasets, investigating data issues and ensuring accurate downstream delivery of financial and commodity data.',
  bullets: [
    'Performed data quality analysis and QA validation on Bloomberg Economy & Energy datasets, identifying discrepancies before client delivery and downstream consumption',
    'Investigated data ingestion, parsing, calculation, and availability failures by comparing source data with system outputs to identify root causes and corrective actions',
    'Prepared discrepancy reports covering affected records, validation findings, and proposed resolutions for client review and approval',
    'Executed approved data corrections and post-fix validation, ensuring accurate and consistent commodity data across downstream Bloomberg channels',
    'Resolved data exceptions within defined SLA, quality, and compliance requirements across live financial and commodity data workflows',
  ],
  skills: ['Data Quality', 'QA Validation', 'Data Analysis', 'Root Cause Analysis', 'Financial Data', 'SQL']
},
  {
    role: 'Data Analyst',
    org: 'Divinelane',
